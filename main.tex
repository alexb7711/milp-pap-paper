...
function, \eqref{eq:objective}, is $m_q = 1000q$. The value of $\epsilon = 1$ for all chargers. This effectively means that
the effort to reduce time on every charger is the same.
