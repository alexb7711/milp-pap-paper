...
The model validity is demonstrated with a randomly generated set of routes for \TODO{NUMBER} buses and \TODO{NUMBER}
visits to the charging station. The results show that the slow chargers are more readily selected and the charging and
spatiotemporal constraints are met while considering the battery dynamics.
...
\TODO{Need a better literature review} A host of techniques have been used to generate the optimal charging schedule.
