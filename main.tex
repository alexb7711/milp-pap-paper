...
\begin{figure}
	...
	\begin{tikzpicture}[scale=0.4]
        ...
        \node[rectangle, draw, fill=gray, minimum width=1cm, minimum height = 1.2cm] at (8,12) {A};
        \node[rectangle, draw, fill=gray, minimum width=1cm, minimum height = 1.2cm] at (12,12) {B};
        \node[rectangle, draw, fill=gray, minimum width=2cm, minimum height = 1.2cm] at (6,7) {D};
        \node[rectangle, draw, fill=gray, minimum width=2cm, minimum height = 1.2cm] at (3,2) {C};
